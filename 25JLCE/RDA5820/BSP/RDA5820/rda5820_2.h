#ifndef __RDA5820_2_H
#define __RDA5820_2_H	 
...
extern u16 freq_2[50];
extern u8 Rssi_2[50];
extern u8 num_2;


u8 RDA5820_Init_2(void);					//��ʼ��		 				    
void RDA5820_WR_Reg_2(u8 addr,u16 val);	//дRDA5820�Ĵ���
u16 RDA5820_RD_Reg_2(u8 addr);			//��RDA5820�Ĵ���
void RDA5820_RX_Mode_2(void);				//����RDA5820ΪRXģʽ
void RDA5820_TX_Mode_2(void);				//����RDA5820ΪTXģʽ
